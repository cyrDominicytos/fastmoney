...
DROP VIEW IF EXISTS `bilan_gains`;
...
-- Listage des données de la table fastmoney.depots : ~0 rows (environ)
...
-- Listage des données de la table fastmoney.parametres : ~2 rows (environ)
...
-- Listage des données de la table fastmoney.parrainages : ~0 rows (environ)
...
-- Listage des données de la table fastmoney.users : ~1 rows (environ)
...
DROP TRIGGER IF EXISTS `depots_after_insert`;
...
DROP TRIGGER IF EXISTS `gains_after_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `retraits_after_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
