...
-- Listage des données de la table fastmoney.depots : ~1 rows (environ)
/*!40000 ALTER TABLE `depots` DISABLE KEYS */;
INSERT INTO `depots` (`id`, `id_user`, `montant`, `pourcentage`, `statut`, `dernier_paye`, `created_at`, `updated_at`) VALUES
	(1, 16, 30, 2.5, 0, '2021-05-26 21:15:03', '2021-05-21 09:14:24', '2021-05-26 21:15:33');
...
-- Listage des données de la table fastmoney.gains : ~8 rows (environ)
/*!40000 ALTER TABLE `gains` DISABLE KEYS */;
INSERT INTO `gains` (`id`, `id_user`, `montant`, `id_depot`, `type`, `created_at`, `updated_at`) VALUES
	(1, 16, 8.25, 1, 1, '2021-05-21 09:10:08', '2021-05-21 09:10:08'),
	(2, 16, 0.75, 1, 1, '2021-05-21 09:15:14', '2021-05-21 09:15:14'),
	(3, 16, 0.75, 1, 1, '2021-05-21 09:20:29', '2021-05-21 09:20:29'),
	(4, 16, 0.75, 1, 1, '2021-05-21 09:25:12', '2021-05-21 09:25:12'),
	(5, 16, 0.75, 1, 1, '2021-05-21 09:30:32', '2021-05-21 09:30:32'),
	(6, 16, 0.75, 1, 1, '2021-05-21 09:35:17', '2021-05-21 09:35:17'),
	(7, 16, 0.75, 1, 1, '2021-05-21 09:40:13', '2021-05-21 09:40:13'),
	(8, 16, 0.75, 1, 1, '2021-05-21 09:45:09', '2021-05-21 09:45:09'),
	(9, 16, 0.75, 1, 1, '2021-05-21 09:50:06', '2021-05-21 09:50:06'),
	(10, 16, 0.75, 1, 1, '2021-05-21 09:55:30', '2021-05-21 09:55:30'),
	(11, 16, 1182, 1, 1, '2021-05-26 21:15:33', '2021-05-26 21:15:33');
...
-- Listage des données de la table fastmoney.invoices : ~8 rows (environ)
/*!40000 ALTER TABLE `invoices` DISABLE KEYS */;
INSERT INTO `invoices` (`id`, `code`, `address`, `price`, `status`, `offre`, `ip`, `created_at`, `updated_at`) VALUES
	(1, '9hxc75oQkTFCM3Uq4BSCJ33GN', '3AF6t7AQBL5sELX61j14y3ZRqPiJYM4Yw6', 50, -1, 2, '127.0.0.1', '2021-05-26 21:16:04', '2021-05-26 21:16:04'),
	(2, '4kYGnx3lPRrPI9IPGxE6a6rXO', '3DJuAkgtTMEyTWPNdSUHfiKdqY87Frvgui', 50, -1, 2, '127.0.0.1', '2021-05-26 21:18:21', '2021-05-26 21:18:21'),
	(3, 'B3Ab733snoMJFjxX9Ccb4GBlb', '3P12xWtsuw6va93tZEJjS5Pf6M8hQaapCA', 50, -1, 2, '127.0.0.1', '2021-05-26 21:18:34', '2021-05-26 21:18:34'),
	(4, 'MSx0ZFxUZEvsQZTUJoU8zxyxm', '36WHrwoN8ecoynVqGeXKufmqb3YmbSbxa3', 50, -1, 2, '127.0.0.1', '2021-05-26 21:20:24', '2021-05-26 21:20:24'),
	(5, '8XphJS6U9yKKf6ByMwPDyE18z', '31pmCL9zAFzRgF9DBVfiQibd6jSzCwKud6', 50, -1, 2, '127.0.0.1', '2021-05-26 21:21:01', '2021-05-26 21:21:01'),
	(6, 'VWhKo5bnvaUf1ZeYwbdBTrf0o', '3Kegy3MXarVifaR32Eocc9iexHwohFfAKD', 50, -1, 2, '127.0.0.1', '2021-05-26 21:21:13', '2021-05-26 21:21:13'),
	(7, 'HiJeaqxCITO92Fl5netPItqAp', '3AnDJ8jvPwKNsG21xou1YNXXPMUooiPmz9', 50, -1, 2, '127.0.0.1', '2021-05-26 21:21:36', '2021-05-26 21:21:36'),
	(8, 'q0aZqGFAHCBQpHWU9asCouTmS', '37e8Kp7tRRYyMmpeYjdnVAyZzXLsau5aPr', 50, -1, 2, '127.0.0.1', '2021-05-26 21:21:45', '2021-05-26 21:21:45'),
	(9, 'qUaznQrD9AUCey9G8SQ4jbyw3', '32X2NGGdpLwamzmHBDomUD2AKL1CRptL4B', 1000, -1, 5, '127.0.0.1', '2021-05-26 21:21:58', '2021-05-26 21:21:58');
...
INSERT INTO `parametres` (`id`, `code`, `designation`, `double_value`, `int_value`, `string_value`, `created_at`, `updated_at`) VALUES
	(1, 'gain_parrain', 'Cote de parrainage', 3, NULL, NULL, '2021-04-23 22:53:19', '2021-04-23 22:53:21'),
	(2, 'limite_gain', 'Pourcentage Limite Gain', 300, NULL, NULL, '2021-04-24 20:35:28', '2021-04-24 20:35:31');
...
INSERT INTO `password_resets` (`email`, `token`, `created_at`) VALUES
	('admin@gmail.com', '$2y$10$RhCHLPFUxnFRTmjYI5m0ueTjS.EwWqyuGAL0Gwxpie3rcqPlcftY.', '2021-04-17 16:24:53');
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('gAjCO0ziytFYRrLslVcEPs7UpJdd0fHXvzO27KBH', 16, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36', '', 1622072453),
	('ZnazU9i8K7iunwRHgvjQcY7DkTdW6LpoPWQySr1m', 16, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.114 Safari/537.36', '', 1625139268);
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `remember_token`, `current_team_id`, `profile_photo_path`, `created_at`, `updated_at`, `solde`, `links`, `username`, `referent`, `pays`, `tel`, `portefeuille`, `statut`) VALUES
	(16, 'Admin System', 'admin@gmail.com', NULL, '$2y$10$yFLwOkSvl/4d7pU.C/HgrOZ2Q6aOQwiyq7GwswE1WzY4pokVHVRES', NULL, NULL, NULL, NULL, NULL, '2021-04-24 19:34:27', '2021-05-17 03:21:00', 1197, 'http://127.0.0.1:8000/parrain/crypto', 'crypto', NULL, 'BJ', '0546464213', 'D9pgas5tFpJqKiqdaTe12qTVUs1RfJ4kFN', '1');
